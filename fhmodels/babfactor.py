...
df = pd.read_csv("~/Desktop/DataA.csv", sep=",")            # MKT + Securities Returns

df_rf = pd.read_csv("~/Desktop/DataF.csv", sep=",")        # Risk Free
...
df_normbeta = (df_betas * 0.5) + 0.5                                  # Securities Ajusted Betas
